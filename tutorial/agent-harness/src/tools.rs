//! The chapter's only tool: bounded reads inside the Workspace.
...
/// Reads a text file inside the Workspace, with optional line offset/limit.
pub struct ReadTool {
    workspace: Workspace,
}
...
impl Tool for ReadTool {
    ...
    fn validate_arguments(&self, arguments: &Value) -> Result<(), ToolError> {
        ...
        // as_u64() rejects bools and negatives alike, so both are caught here.
