# Reader AI Coding Workflow v1

- **Status:** Accepted
- **Decision date:** 2026-08-17
- **Scope:** 本书逐章教学工程的 AI Coding 工作流
- **Protocol assets:** `docs/prompts/workflow/v1/`
...
采用 `docs/prompts/workflow/v1/` 中的跨平台工作流协议。一次章节任务由总控维护状态，并按顺序调度七种逻辑角色：
...
`v1` 是协议主版本。破坏角色权限、人工门禁、状态语义或任务包必填字段的变更必须创建新主版本目录。非破坏性文字修订可以更新 v1，但必须在 v1 README 的修订记录中说明。
