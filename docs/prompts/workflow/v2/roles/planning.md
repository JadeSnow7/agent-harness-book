...
Preserve every complete plan and implementation Prompt. Corrections are new
attempts linked with `revision_of`; record and verify before implementation
approval. Planning remains read-only.
